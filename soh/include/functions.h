...
u8 Player_CanUseSwordBeams(Player* this); // FD (2026-07-11) RE z_player_lib.c:1712
s32 Player_CheckZTargeting2(Player* this); // FD (2026-07-11) RE z_player_lib.c:1704
...
void Audio_QueuePreviewSeqCmdOnPlayer(u8 playerIdx, u16 seqId); // FD (2026-07-12): non-clobbering custom-seq start
