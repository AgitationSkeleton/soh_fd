...
// LINK_AGE_DEITY reuses OBJECT_LINK_BOY: the FD model resources ship inside object_link_boy (via fd.o2r,
// paths objects/object_link_boy/gLinkFierceDeity*), so no separate deity object load is needed. This keeps
// gLinkObjectIds[gSaveContext.linkAge] in-bounds at DEITY. aegiker RE->SoH port 2026-07-11.
s16 gLinkObjectIds[] = { OBJECT_LINK_BOY, OBJECT_LINK_CHILD, OBJECT_LINK_BOY };
