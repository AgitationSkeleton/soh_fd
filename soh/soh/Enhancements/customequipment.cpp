...
#include "objects/object_link_deity/object_link_deity.h" // FD (2026-07-12): gLinkFierceDeityRightHandHoldingOot*DL
...
static void ApplyCommonEquipmentPatches() {
    ...
    // FD (2026-07-13): Fierce Deity's Fairy/OoT ocarina is handled SELF-CONTAINED in z_player_lib.c (FD bare hand +
    // the correct ocarina DL bundled in fd.o2r), so it works without the alt-asset pack -- no FD entries here.
