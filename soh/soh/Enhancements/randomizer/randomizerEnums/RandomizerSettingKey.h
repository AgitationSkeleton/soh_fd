...
// FD (2026-07-13): moved here from mid-enum (was after RSK_ROCS_FEATHER) so it no longer shifts RSK_SHUFFLE_ICICLES/
// RSK_SHUFFLE_RED_ICE/RSK_MAX. Keep FD setting keys appended before RSK_MAX.
RANDO_ENUM_ITEM(RSK_FIERCE_DEITY_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_FIERCE_DEITY_MASK) // FD (2026-07-12): appended before MAX so existing setting indices don't shift
