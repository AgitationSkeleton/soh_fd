...
void Settings::CreateOptions() {
    ...
    // FD (2026-07-13): default this fork's Fierce Deity's Mask shuffle to ON (checked). The trailing args are the
    // Option::Bool defaults (imFlags / widget type) except the last -> defaultOption_ = true = default checked.
    OPT_BOOL(RSK_FIERCE_DEITY_MASK, "Fierce Deity's Mask", CVAR_RANDOMIZER_SETTING("FierceDeityMask"), mOptionDescriptions[RSK_FIERCE_DEITY_MASK], IMFLAG_SEPARATOR_BOTTOM, WIDGET_CVAR_CHECKBOX, true);
    ...
    // FD (2026-07-12): "Start with Fierce Deity's Mask" starting equip -- grants the mask at file creation and
    // (via item_pool.cpp) removes it from the shuffled pool, exactly like the other starting equips.
    OPT_BOOL(RSK_STARTING_FIERCE_DEITY_MASK, "Start with Fierce Deity's Mask", CVAR_RANDOMIZER_SETTING("StartingFierceDeityMask"));
    ...
    */
    ...
    mOptionGroups[RSG_MENU_SECTION_ADDITIONAL_ITEMS] = OptionGroup::SubGroup("Additional Items",
                                                                             {
                                                                                 ...
                                                                                 &mOptions[RSK_FIERCE_DEITY_MASK],
    ...
    mOptionGroups[RSG_MENU_SECTION_STARTING_EQUIPS] = OptionGroup::SubGroup(
        ...
        { &mOptions[RSK_LINKS_POCKET], &mOptions[RSK_LINKS_POCKET_REWARD], &mOptions[RSK_STARTING_KOKIRI_SWORD],
          ...
          &mOptions[RSK_STARTING_FIERCE_DEITY_MASK] },
        WidgetContainerType::SECTION);
