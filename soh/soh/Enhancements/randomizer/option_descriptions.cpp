...
void Settings::CreateOptionDescriptions() {
    ...
    mOptionDescriptions[RSK_FIERCE_DEITY_MASK] =
        "Adds the Fierce Deity's Mask to the item pool. When collected it equips to a C-button and lets the "
        "player transform into the Fierce Deity. The mask is not considered by logic.";
