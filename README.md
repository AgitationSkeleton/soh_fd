...
- **[MM_Jumps](https://github.com/Neirn/MM_Jumps)** by **Neirn** (ModLoader64 addon) — the Majora's Mask front-flip and somersault jump animations used by the "MM Jump Flips" feature.
